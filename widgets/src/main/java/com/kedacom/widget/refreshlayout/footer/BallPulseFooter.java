...
//    protected SpinnerStyle mSpinnerStyle = SpinnerStyle.Translate;
    ...
    protected Map<ValueAnimator, AnimatorUpdateListener> mUpdateListeners = new HashMap<>();
    ;
    //</editor-fold>
    ...
    public BallPulseFooter(@NonNull Context context, @Nullable AttributeSet attrs,
        ...
        thisView.setMinimumHeight(SystemUtil.dp2px(60));
        ...
        mSpinnerStyle = SpinnerStyle.values()[ta
            .getInt(R.styleable.BallPulseFooter_srlClassicsSpinnerStyle, mSpinnerStyle.ordinal())];
        ...
        mCircleSpacing = SystemUtil.dp2px(4);
