...
public class FunGameHitBlockHeader extends FunGameView {
    ...
    public FunGameHitBlockHeader(Context context, AttributeSet attrs, int defStyle) {
        ...
        speed = ta.getInt(R.styleable.FunGameHitBlockHeader_fghBallSpeed, dp2px(SPEED));
        blockHorizontalNum = ta
            .getInt(R.styleable.FunGameHitBlockHeader_fghBlockHorizontalNum, BLOCK_HORIZONTAL_NUM);
        ta.recycle();
    ...
    protected void drawBallPath(Canvas canvas, int width) {
        ...
        if (cx <= blockLeft + blockHorizontalNum * blockWidth
            + (blockHorizontalNum - 1) * DIVIDING_LINE_SIZE + BALL_RADIUS) { // 小球进入到色块区域
