package com.kedacom.widget.refreshlayout.internal;

import static android.view.ViewGroup.LayoutParams.WRAP_CONTENT;
import static com.kedacom.widget.refreshlayout.constant.SpinnerStyle.Translate;
...
public abstract class InternalClassics<T extends InternalClassics> extends
    InternalAbstract implements
    RefreshInternal {
    ...
    public InternalClassics(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LinearLayout.LayoutParams lpHeaderText = new LinearLayout.LayoutParams(WRAP_CONTENT,
            WRAP_CONTENT);
        ...
        LayoutParams lpArrow = new LayoutParams(SystemUtil.dp2px(20), SystemUtil.dp2px(20));
        ...
        if (thisView.getPaddingTop() == 0) {
            if (thisView.getPaddingBottom() == 0) {
                thisView.setPadding(thisView.getPaddingLeft(), mPaddingTop = SystemUtil.dp2px(20),
                    thisView.getPaddingRight(), mPaddingBottom = SystemUtil.dp2px(20));
            } else {
                thisView.setPadding(thisView.getPaddingLeft(), mPaddingTop = SystemUtil.dp2px(20),
                    thisView.getPaddingRight(), mPaddingBottom = thisView.getPaddingBottom());
            }
        } else {
            if (thisView.getPaddingBottom() == 0) {
                thisView
                    .setPadding(thisView.getPaddingLeft(), mPaddingTop = thisView.getPaddingTop(),
                        thisView.getPaddingRight(), mPaddingBottom = SystemUtil.dp2px(20));
            } else {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (MeasureSpec.getMode(heightMeasureSpec) == MeasureSpec.EXACTLY) {
            ...
            thisView.setPadding(thisView.getPaddingLeft(), mPaddingTop, thisView.getPaddingRight(),
                mPaddingBottom);
        }
...
//        mTitleText.setTitleSize(unit, size);
//        if (mRefreshKernel != null) {
//            if (this instanceof RefreshHeader) {
...
//    }
    ...
    public T setDrawableMarginRight(float dp) {
        ...
        lpArrow.rightMargin = lpProgress.rightMargin = SystemUtil.dp2px(dp);
...
//    }
    ...
    public T setDrawableSize(float dp) {
        ...
        lpArrow.width = lpProgress.width = SystemUtil.dp2px(dp);
        lpArrow.height = lpProgress.height = SystemUtil.dp2px(dp);
        arrowView.setLayoutParams(lpArrow);
        progressView.setLayoutParams(lpProgress);
        return self();
    }
...
//    }
    ...
    public T setDrawableArrowSize(float dp) {
        final View arrowView = mArrowView;
        ViewGroup.LayoutParams lpArrow = arrowView.getLayoutParams();
        lpArrow.height = lpArrow.width = SystemUtil.dp2px(dp);
        arrowView.setLayoutParams(lpArrow);
        return self();
    }
...
//    }
    ...
    public T setDrawableProgressSize(float dp) {
        final View progressView = mProgressView;
        ViewGroup.LayoutParams lpProgress = progressView.getLayoutParams();
        lpProgress.height = lpProgress.width = SystemUtil.dp2px(dp);
        progressView.setLayoutParams(lpProgress);
        return self();
    }
