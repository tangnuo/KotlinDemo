...
import com.kedacom.widget.refreshlayout.header.internal.MaterialProgressDrawable;
import com.kedacom.widget.refreshlayout.header.waveswipe.WaveView;
import com.kedacom.widget.refreshlayout.internal.InternalAbstract;


/**
 * 水滴下拉头 from https://github.com/recruit-lifestyle/WaveSwipeRefreshLayout
 */
...
public class WaveSwipeHeader extends InternalAbstract implements RefreshHeader {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        waveView.measure(makeMeasureSpec(getSize(widthMeasureSpec), EXACTLY),
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        circleView
            .layout((thisWidth - circleWidth) / 2, -circleHeight, (thisWidth + circleWidth) / 2, 0);

        if (thisView.isInEditMode()) {
            onMoving(true, 0.99f, dp2px(99), dp2px(100), dp2px(100));
//            onPulling(0.99f, SmartUtil.dp2px(99), SmartUtil.dp2px(100), SmartUtil.dp2px(100));
    ...
    public void onMoving(boolean isDragging, float percent, int offset, int height,
        ...
        if (isDragging) {
            ...
            final View thisView = this;
            float seed =
                1f * offset / Math.min(thisView.getMeasuredWidth(), thisView.getMeasuredHeight());
...
//        Resources resources = context.getResources();
    ...
    /**
     * Custom view has progress drawable. Some features of MaterialProgressDrawable are decorated.
     *
     * @author jmatsu
     */
