...
/**
 * Refresh your delivery! design https://dribbble.com/shots/2753803-Refresh-your-delivery
 */
...
//        cloudDrawable.printOriginal("cloudDrawable");
        ...
        cloudDrawable.setGeometricHeight(dp2px(20));
...
//        umbrellaDrawable.printOriginal("umbrellaDrawable");
        ...
        umbrellaDrawable.setGeometricWidth(dp2px(200));
...
//        boxDrawable.printOriginal("boxDrawable");
        ...
        boxDrawable.setGeometricWidth(dp2px(50));
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (mState == RefreshState.Refreshing
            ...
            mCloudDrawable.draw(canvas);
            canvas.rotate(5 * (float) Math.sin(mAppreciation / 2), width / 2f,
                mHeaderHeight / 2f - mUmbrellaDrawable.getBounds().height());
        ...
        final int centerYBox = centerY + (mHeaderHeight / 2 - mBoxDrawable.getBounds().height())
            - Math
            .min(mHeaderHeight / 2 - mBoxDrawable.getBounds().height(), dp2px(mAppreciation * 100));
        mBoxDrawable.getBounds().offsetTo(width / 2 - mBoxDrawable.getBounds().width() / 2,
            centerYBox - mBoxDrawable.getBounds().height() / 4);
        mBoxDrawable.draw(canvas);

        if (mState == RefreshState.Refreshing
            || mState == RefreshState.RefreshFinish) {
            Rect bounds = mUmbrellaDrawable.getBounds();
            final int centerYUmbrella =
                centerY - mHeaderHeight + Math.min(mHeaderHeight, dp2px(mAppreciation * 100));
            mUmbrellaDrawable.getBounds()
                .offsetTo(width / 2 - bounds.width() / 2, centerYUmbrella - bounds.height());
