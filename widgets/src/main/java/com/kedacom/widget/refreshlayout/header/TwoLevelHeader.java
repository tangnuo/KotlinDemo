...
import com.kedacom.widget.refreshlayout.api.OnTwoLevelListener;
...
public class TwoLevelHeader extends InternalAbstract implements
...
//    protected Method mRequestDrawBackgroundForHeaderMethod;
    ...
    public TwoLevelHeader(@NonNull Context context, @Nullable AttributeSet attrs,
        ...
        mEnableTwoLevel = ta
            .getBoolean(R.styleable.TwoLevelHeader_srlEnableTwoLevel, mEnableTwoLevel);
        mEnablePullToCloseTwoLevel = ta
            .getBoolean(R.styleable.TwoLevelHeader_srlEnablePullToCloseTwoLevel,
                mEnablePullToCloseTwoLevel);
        ...
        if (refreshHeader != null) {
            ...
            if (mode == MeasureSpec.AT_MOST) {
                ...
                super.setMeasuredDimension(
                    View.resolveSize(super.getSuggestedMinimumWidth(), widthMeasureSpec), height);
            } else {
...
//                }
                    ...
                    if (refreshKernel != null) {
                        ...
                        refreshKernel.startTwoLevel(
                            twoLevelListener == null || twoLevelListener.onTwoLevel(refreshLayout));
                    }
                    break;
                case TwoLevel:
                    break;
                ...
                case PullDownToRefresh:
                    if (refreshHeader.getView().getAlpha() == 0
                        && refreshHeader.getView() != this) {
        ...
        if (mSpinner != spinner && refreshHeader != null) {
            ...
            switch (refreshHeader.getSpinnerStyle()) {
                ...
                case Scale: {
                    ...
                    view.layout(view.getLeft(), view.getTop(), view.getRight(), view.getTop() + Math
                        .max(0, spinner));
                    break;
                }
            }
