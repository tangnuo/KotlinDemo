...
import com.kedacom.widget.refreshlayout.header.waterdrop.WaterDropView;
...
/**
 * WaterDropHeader from https://github.com/THEONE10211024/WaterDropListView
 */
public class WaterDropHeader extends InternalAbstract implements RefreshHeader {
    ...
    public WaterDropHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        progressDrawable.setBounds(0, 0, dp2px(20), dp2px(20));
        ...
        thisGroup.addView(mImageView, dp2px(30), dp2px(30));
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        super.setMeasuredDimension(View.resolveSize(maxWidth, widthMeasureSpec),
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        dropView.layout(leftWaterDrop, topWaterDrop, leftWaterDrop + widthWaterDrop,
