...
import com.kedacom.widget.refreshlayout.util.ScrollBoundaryUtil;
...
//        }
        ...
        return ScrollBoundaryUtil
            .canLoadMore(content, mActionEvent, mEnableLoadMoreWhenContentNotFull);
    }
    //</editor-fold>
}
