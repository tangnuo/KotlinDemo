package com.kedacom.widget.refreshlayout.impl;

import static android.view.ViewGroup.LayoutParams.MATCH_PARENT;
import static com.kedacom.widget.refreshlayout.util.ScrollBoundaryUtil.canScrollDown;
import static com.kedacom.widget.refreshlayout.util.ScrollBoundaryUtil.canScrollUp;
import static com.kedacom.widget.refreshlayout.util.ScrollBoundaryUtil.isTransformedTouchPointInView;
import static com.kedacom.widget.refreshlayout.util.SmartUtil.isContentView;
import static com.kedacom.widget.refreshlayout.util.SmartUtil.measureViewHeight;
import static com.kedacom.widget.refreshlayout.util.SmartUtil.scrollListBy;
...
import com.kedacom.widget.refreshlayout.listener.CoordinatorLayoutListener;
import com.kedacom.widget.refreshlayout.util.DesignUtil;
...
public class RefreshContentWrapper implements RefreshContent, CoordinatorLayoutListener,
...
//        mBoundaryAdapter.setEnableLoadMoreWhenContentNotFull(enable);
    ...
    public AnimatorUpdateListener scrollContentWhenFinished(final int spinner) {
        if (mScrollableView != null && spinner != 0) {
            if ((spinner < 0 && canScrollDown(mScrollableView)) || (spinner > 0 && canScrollUp(
                mScrollableView))) {
