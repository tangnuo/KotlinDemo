...
import com.kedacom.widget.refreshlayout.header.material.CircleImageView;
...
public class MaterialHeader extends InternalAbstract implements RefreshHeader {
    ...
    public MaterialHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mShowBezierWave = ta
            .getBoolean(R.styleable.MaterialHeader_mhShowBezierWave, mShowBezierWave);
...
//                resolveSize(getSuggestedMinimumHeight(), heightMeasureSpec));
    ...
    protected void dispatchDraw(Canvas canvas) {
        if (mShowBezierWave) {
            ...
            //绘制贝塞尔曲线
            final View thisView = this;
            mBezierPath.quadTo(thisView.getMeasuredWidth() / 2f, mHeadHeight + mWaveHeight * 1.9f,
                thisView.getMeasuredWidth(), mHeadHeight);
