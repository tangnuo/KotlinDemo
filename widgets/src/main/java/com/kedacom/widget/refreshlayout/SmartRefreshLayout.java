package com.kedacom.widget.refreshlayout;
...
import static com.kedacom.widget.refreshlayout.util.SmartUtil.fling;
import static com.kedacom.widget.refreshlayout.util.SmartUtil.getColor;
import static com.kedacom.widget.refreshlayout.util.SmartUtil.isContentView;
...
import com.kedacom.widget.refreshlayout.api.DefaultRefreshFooterCreator;
import com.kedacom.widget.refreshlayout.api.DefaultRefreshHeaderCreator;
import com.kedacom.widget.refreshlayout.api.DefaultRefreshInitializer;
import com.kedacom.widget.refreshlayout.api.RefreshContent;
import com.kedacom.widget.refreshlayout.api.RefreshFooter;
import com.kedacom.widget.refreshlayout.api.RefreshHeader;
import com.kedacom.widget.refreshlayout.api.RefreshInternal;
import com.kedacom.widget.refreshlayout.api.RefreshKernel;
import com.kedacom.widget.refreshlayout.api.RefreshLayout;
import com.kedacom.widget.refreshlayout.api.ScrollBoundaryDecider;
import com.kedacom.widget.refreshlayout.constant.DimensionStatus;
import com.kedacom.widget.refreshlayout.constant.RefreshState;
import com.kedacom.widget.refreshlayout.constant.SpinnerStyle;
import com.kedacom.widget.refreshlayout.footer.BallPulseFooter;
import com.kedacom.widget.refreshlayout.header.BezierRadarHeader;
import com.kedacom.widget.refreshlayout.impl.RefreshContentWrapper;
import com.kedacom.widget.refreshlayout.impl.RefreshFooterWrapper;
import com.kedacom.widget.refreshlayout.impl.RefreshHeaderWrapper;
import com.kedacom.widget.refreshlayout.listener.OnLoadMoreListener;
import com.kedacom.widget.refreshlayout.listener.OnMultiPurposeListener;
import com.kedacom.widget.refreshlayout.listener.OnRefreshListener;
import com.kedacom.widget.refreshlayout.listener.OnRefreshLoadMoreListener;
import com.kedacom.widget.refreshlayout.listener.OnStateChangedListener;
import com.kedacom.widget.refreshlayout.util.DelayedRunnable;
import com.kedacom.widget.refreshlayout.util.ViscousFluidInterpolator;
import java.util.ArrayList;
import java.util.List;

/**
 * 智能刷新布局 Intelligent RefreshLayout
 */
...
public class SmartRefreshLayout extends ViewGroup implements RefreshLayout,
    ...
    public SmartRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mFooterHeight = SystemUtil.dp2px(60);
        mHeaderHeight = SystemUtil.dp2px(100);
        ...
        mHeaderHeight = ta
            .getDimensionPixelOffset(R.styleable.SmartRefreshLayout_srlHeaderHeight, mHeaderHeight);
        mFooterHeight = ta
            .getDimensionPixelOffset(R.styleable.SmartRefreshLayout_srlFooterHeight, mFooterHeight);
        mHeaderInsetStart = ta
            .getDimensionPixelOffset(R.styleable.SmartRefreshLayout_srlHeaderInsetStart,
                mHeaderInsetStart);
        mFooterInsetStart = ta
            .getDimensionPixelOffset(R.styleable.SmartRefreshLayout_srlFooterInsetStart,
                mFooterInsetStart);
        mDisableContentWhenRefresh = ta
            .getBoolean(R.styleable.SmartRefreshLayout_srlDisableContentWhenRefresh,
                mDisableContentWhenRefresh);
        mDisableContentWhenLoading = ta
            .getBoolean(R.styleable.SmartRefreshLayout_srlDisableContentWhenLoading,
                mDisableContentWhenLoading);
        mEnableHeaderTranslationContent = ta
            .getBoolean(R.styleable.SmartRefreshLayout_srlEnableHeaderTranslationContent,
                mEnableHeaderTranslationContent);
        mEnableFooterTranslationContent = ta
            .getBoolean(R.styleable.SmartRefreshLayout_srlEnableFooterTranslationContent,
                mEnableFooterTranslationContent);
        mEnablePreviewInEditMode = ta
            .getBoolean(R.styleable.SmartRefreshLayout_srlEnablePreviewInEditMode,
                mEnablePreviewInEditMode);
        mEnableAutoLoadMore = ta
            .getBoolean(R.styleable.SmartRefreshLayout_srlEnableAutoLoadMore, mEnableAutoLoadMore);
        mEnableOverScrollBounce = ta
            .getBoolean(R.styleable.SmartRefreshLayout_srlEnableOverScrollBounce,
                mEnableOverScrollBounce);
        mEnablePureScrollMode = ta
            .getBoolean(R.styleable.SmartRefreshLayout_srlEnablePureScrollMode,
                mEnablePureScrollMode);
        mEnableScrollContentWhenLoaded = ta
            .getBoolean(R.styleable.SmartRefreshLayout_srlEnableScrollContentWhenLoaded,
                mEnableScrollContentWhenLoaded);
        mEnableScrollContentWhenRefreshed = ta
            .getBoolean(R.styleable.SmartRefreshLayout_srlEnableScrollContentWhenRefreshed,
                mEnableScrollContentWhenRefreshed);
        mEnableLoadMoreWhenContentNotFull = ta
            .getBoolean(R.styleable.SmartRefreshLayout_srlEnableLoadMoreWhenContentNotFull,
                mEnableLoadMoreWhenContentNotFull);
        mEnableFooterFollowWhenLoadFinished = ta
            .getBoolean(R.styleable.SmartRefreshLayout_srlEnableFooterFollowWhenLoadFinished,
                mEnableFooterFollowWhenLoadFinished);
        mEnableClipHeaderWhenFixedBehind = ta
            .getBoolean(R.styleable.SmartRefreshLayout_srlEnableClipHeaderWhenFixedBehind,
                mEnableClipHeaderWhenFixedBehind);
        mEnableClipFooterWhenFixedBehind = ta
            .getBoolean(R.styleable.SmartRefreshLayout_srlEnableClipFooterWhenFixedBehind,
                mEnableClipFooterWhenFixedBehind);
        mEnableOverScrollDrag = ta
            .getBoolean(R.styleable.SmartRefreshLayout_srlEnableOverScrollDrag,
                mEnableOverScrollDrag);
        mFixedHeaderViewId = ta
            .getResourceId(R.styleable.SmartRefreshLayout_srlFixedHeaderViewId, mFixedHeaderViewId);
        mFixedFooterViewId = ta
            .getResourceId(R.styleable.SmartRefreshLayout_srlFixedFooterViewId, mFixedFooterViewId);
        mHeaderTranslationViewId = ta
            .getResourceId(R.styleable.SmartRefreshLayout_srlHeaderTranslationViewId,
                mHeaderTranslationViewId);
        mFooterTranslationViewId = ta
            .getResourceId(R.styleable.SmartRefreshLayout_srlFooterTranslationViewId,
                mFooterTranslationViewId);

        if (mEnablePureScrollMode && !ta
            .hasValue(R.styleable.SmartRefreshLayout_srlEnableOverScrollDrag)) {
            mEnableOverScrollDrag = true;
        }

        mManualLoadMore =
            mManualLoadMore || ta.hasValue(R.styleable.SmartRefreshLayout_srlEnableLoadMore);
        mManualHeaderTranslationContent = mManualHeaderTranslationContent || ta
            .hasValue(R.styleable.SmartRefreshLayout_srlEnableHeaderTranslationContent);
        mManualFooterTranslationContent = mManualFooterTranslationContent || ta
            .hasValue(R.styleable.SmartRefreshLayout_srlEnableFooterTranslationContent);
        mManualNestedScrolling = mManualNestedScrolling || ta
            .hasValue(R.styleable.SmartRefreshLayout_srlEnableNestedScrolling);
        mHeaderHeightStatus = ta.hasValue(R.styleable.SmartRefreshLayout_srlHeaderHeight)
            ? DimensionStatus.XmlLayoutUnNotify : mHeaderHeightStatus;
        mFooterHeightStatus = ta.hasValue(R.styleable.SmartRefreshLayout_srlFooterHeight)
            ? DimensionStatus.XmlLayoutUnNotify : mFooterHeightStatus;
    ...
    protected void onFinishInflate() {
        ...
        for (int i = 0; i < count; i++) {
            View view = super.getChildAt(i);
            if (i == indexHeader || (i != indexFooter && indexHeader == -1 && mRefreshHeader == null
                && view instanceof RefreshHeader)) {
                mRefreshHeader = (view instanceof RefreshHeader) ? (RefreshHeader) view
                ...
                mRefreshFooter = (view instanceof RefreshFooter) ? (RefreshFooter) view
...
//                mRefreshContent = new RefreshContentWrapper(view);
    ...
    protected void onAttachedToWindow() {
        ...
        if (!thisView.isInEditMode()) {
            ...
            if (mRefreshContent == null) {
                final int padding = SystemUtil.dp2px(20);
            ...
            View fixedHeaderView =
                mFixedHeaderViewId > 0 ? thisView.findViewById(mFixedHeaderViewId) : null;
            View fixedFooterView =
                mFixedFooterViewId > 0 ? thisView.findViewById(mFixedFooterViewId) : null;
            ...
            if (mSpinner != 0) {
                ...
                mRefreshContent
                    .moveSpinner(mSpinner = 0, mHeaderTranslationViewId, mFooterTranslationViewId);
            }
                    ...
                    public void run() {
                        ...
                        for (ViewParent parent = thisView.getParent(); parent != null; ) {
                            if (parent instanceof NestedScrollingParent) {
                                ...
                                if (((NestedScrollingParent) parent)
                                    .onStartNestedScroll(target, target,
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        for (int i = 0, len = super.getChildCount(); i < len; i++) {
            ...
            if (mRefreshHeader != null && mRefreshHeader.getView() == child) {
                ...
                if (mHeaderHeightStatus.ordinal() < DimensionStatus.XmlLayoutUnNotify.ordinal()) {
                    if (lp.height > 0) {
                        ...
                        final int maxHeight = Math
                            .max(getSize(heightMeasureSpec) - lp.bottomMargin - lp.topMargin, 0);
                        headerView.measure(widthSpec, makeMeasureSpec(maxHeight, AT_MOST));
                        final int measuredHeight = headerView.getMeasuredHeight();
                        if (measuredHeight > 0) {
                            height = -1;
                            if (measuredHeight != (maxHeight) && mHeaderHeightStatus
                                .canReplaceWith(DimensionStatus.XmlWrapUnNotify)) {
                ...
                if (height != -1) {
                    headerView.measure(widthSpec, makeMeasureSpec(
                        Math.max(height - lp.bottomMargin - lp.topMargin, 0), EXACTLY));
                }

                if (!mHeaderHeightStatus.notified) {
                    mHeaderHeightStatus = mHeaderHeightStatus.notified();
                    mRefreshHeader.onInitialized(mKernel, mHeaderHeight,
            ...
            if (mRefreshFooter != null && mRefreshFooter.getView() == child) {
                ...
                if (mFooterHeightStatus.ordinal() < DimensionStatus.XmlLayoutUnNotify.ordinal()) {
                    if (lp.height > 0) {
                        ...
                        if (measuredHeight > 0) {
                            height = -1;
                            if (measuredHeight != (maxHeight) && mFooterHeightStatus
                                .canReplaceWith(DimensionStatus.XmlWrapUnNotify)) {
                ...
                if (mRefreshFooter.getSpinnerStyle() == SpinnerStyle.MatchLayout) {
                    ...
                    height = Math
                        .max(0, isEnableRefreshOrLoadMore(mEnableLoadMore) ? -mSpinner : 0);
                }

                if (height != -1) {
                    footerView.measure(widthSpec, makeMeasureSpec(
                        Math.max(height - lp.bottomMargin - lp.topMargin, 0), EXACTLY));
                }

                if (!mFooterHeightStatus.notified) {
                    mFooterHeightStatus = mFooterHeightStatus.notified();
                    mRefreshFooter.onInitialized(mKernel, mFooterHeight,
            ...
            if (mRefreshContent != null && mRefreshContent.getView() == child) {
                ...
                final boolean showHeader = (mRefreshHeader != null && isEnableRefreshOrLoadMore(
                    mEnableRefresh) && isEnableTranslationContent(mEnableHeaderTranslationContent,
                    mRefreshHeader));
                final boolean showFooter = (mRefreshFooter != null && isEnableRefreshOrLoadMore(
                    mEnableLoadMore) && isEnableTranslationContent(mEnableFooterTranslationContent,
                    mRefreshFooter));
                final int widthSpec = ViewGroup.getChildMeasureSpec(widthMeasureSpec,
                    thisView.getPaddingLeft() + thisView.getPaddingRight() + lp.leftMargin
                        + lp.rightMargin, lp.width);
                final int heightSpec = ViewGroup.getChildMeasureSpec(heightMeasureSpec,
                    thisView.getPaddingTop() + thisView.getPaddingBottom() + lp.topMargin
                        + lp.bottomMargin +
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0, len = super.getChildCount(); i < len; i++) {
            ...
            if (mRefreshContent != null && mRefreshContent.getView() == child) {
                boolean isPreviewMode = thisView.isInEditMode() && mEnablePreviewInEditMode
                    && isEnableRefreshOrLoadMore(mEnableRefresh) && mRefreshHeader != null;
                final View contentView = mRefreshContent.getView();
                final LayoutParams lp = (LayoutParams) contentView.getLayoutParams();
                ...
                if (isPreviewMode && (isEnableTranslationContent(mEnableHeaderTranslationContent,
                    mRefreshHeader))) {
...
//                        bottom = top + Math.max(Math.max(0, isEnableRefreshOrLoadMore(mEnableRefresh) ? mSpinner : 0) - lp.bottomMargin - lp.topMargin, 0);
            ...
            if (mRefreshFooter != null && mRefreshFooter.getView() == child) {
                final boolean isPreviewMode = thisView.isInEditMode() && mEnablePreviewInEditMode
                ...
                if (style == SpinnerStyle.MatchLayout) {
                    ...
                    top = top - Math
                        .max(isEnableRefreshOrLoadMore(mEnableLoadMore) ? -mSpinner : 0, 0);
                }
...
//    }
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (mRefreshHeader != null && mRefreshHeader.getView() == child) {
            if (!isEnableRefreshOrLoadMore(mEnableRefresh) || (!mEnablePreviewInEditMode && thisView
                .isInEditMode())) {
                return true;
            }
            if (contentView != null) {
                int bottom = Math
                    .max(contentView.getTop() + contentView.getPaddingTop() + mSpinner,
                        child.getTop());
                if (mHeaderBackgroundColor != 0 && mPaint != null) {
                    ...
                    canvas.drawRect(child.getLeft(), child.getTop(), child.getRight(), bottom,
                        mPaint);
                }
        ...
        if (mRefreshFooter != null && mRefreshFooter.getView() == child) {
            if (!isEnableRefreshOrLoadMore(mEnableLoadMore) || (!mEnablePreviewInEditMode
                && thisView.isInEditMode())) {
                return true;
            }
            if (contentView != null) {
                int top = Math
                    .min(contentView.getBottom() - contentView.getPaddingBottom() + mSpinner,
                        child.getBottom());
                if (mFooterBackgroundColor != 0 && mPaint != null) {
                    ...
                    canvas.drawRect(child.getLeft(), top, child.getRight(), child.getBottom(),
                        mPaint);
                }
    ...
    public void computeScroll() {
        ...
        if (mScroller.computeScrollOffset()) {
            ...
            if ((finalY < 0 && (mEnableOverScrollDrag || isEnableRefreshOrLoadMore(mEnableRefresh))
                && mRefreshContent.canRefresh())
                || (finalY > 0 && (mEnableOverScrollDrag || isEnableRefreshOrLoadMore(
                ...
                if (mVerticalPermit) {
                    ...
                    if (Build.VERSION.SDK_INT >= 14) {
                        ...
                        velocity = 1f * (mScroller.getCurrY() - finalY) / Math
                            .max((mScroller.getDuration() - mScroller.timePassed()), 1);
                    }
    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        if (mNestedInProgress) {//嵌套滚动时，补充竖直方向不滚动，但是水平方向滚动，需要通知 onHorizontalDrag
            ...
            || (!isEnableRefreshOrLoadMore(mEnableRefresh) && !isEnableRefreshOrLoadMore(
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (mState == RefreshState.TwoLevel
                    && mTouchY < 5 * thisView.getMeasuredHeight() / 6) {
                ...
                if (mIsBeingDragged) {
                    ...
                    if ((mViceState.isHeader && (spinner < 0 || mLastSpinner < 0)) || (
                        ...
                        if (mFalsifyEvent == null) {
                            mFalsifyEvent = obtain(time, time, MotionEvent.ACTION_DOWN,
                                mTouchX + dx, mTouchY, 0);
                            super.dispatchTouchEvent(mFalsifyEvent);
                        }
                        MotionEvent em = obtain(time, time, MotionEvent.ACTION_MOVE, mTouchX + dx,
                            mTouchY + spinner, 0);
                        ...
                        if (spinner > 0 && (
                            (mEnableOverScrollDrag || isEnableRefreshOrLoadMore(mEnableRefresh))
                                && mRefreshContent.canRefresh())) {
                        ...
                        if ((mViceState.isHeader && spinner < 0) || (mViceState.isFooter
                            && spinner > 0)) {
                            if (mSpinner != 0) {
    ...
    protected boolean startFlingIfNeed(Float flingVelocity) {
        ...
        if (Math.abs(velocity) > mMinimumVelocity) {
            ...
            if ((velocity < 0 && (
                (mEnableOverScrollBounce && (mEnableOverScrollDrag || isEnableRefreshOrLoadMore(
                    mEnableLoadMore))) || (mState == RefreshState.Loading && mSpinner >= 0) || (
                    mEnableAutoLoadMore && isEnableRefreshOrLoadMore(mEnableLoadMore))))
                || (velocity > 0 && (
                (mEnableOverScrollBounce && (mEnableOverScrollDrag || isEnableRefreshOrLoadMore(
                    mEnableRefresh))) || (mState == RefreshState.Refreshing && mSpinner <= 0)))) {
                mVerticalPermit = false;//关闭竖直通行证
                mScroller
                    .fling(0, 0, 0, (int) -velocity, 0, 0, -Integer.MAX_VALUE, Integer.MAX_VALUE);
...
//            }
            ...
            if (mRefreshFooter != null) {
                mRefreshFooter.onStartAnimator(this, mFooterHeight,
                    (int) (mFooterMaxDragRate * mFooterHeight));
            }
            if (mOnMultiPurposeListener != null && mRefreshFooter instanceof RefreshFooter) {
                ...
                mOnMultiPurposeListener
                    .onFooterStartAnimator((RefreshFooter) mRefreshFooter, mFooterHeight,
                        (int) (mFooterMaxDragRate * mFooterHeight));
            }
        }
    }
    ...
    protected void setStateLoading() {
        ...
        if (mRefreshFooter != null) {
            ...
            mRefreshFooter
                .onReleased(this, mFooterHeight, (int) (mFooterMaxDragRate * mFooterHeight));
        }
        if (mOnMultiPurposeListener != null && mRefreshFooter instanceof RefreshFooter) {
    ...
    protected void setStateRefreshing() {
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    ...
                    mOnMultiPurposeListener
                        .onHeaderStartAnimator((RefreshHeader) mRefreshHeader, mHeaderHeight,
                            (int) (mHeaderMaxDragRate * mHeaderHeight));
                }
            }
        };
        ...
        if (mRefreshHeader != null) {
            ...
            mRefreshHeader
                .onReleased(this, mHeaderHeight, (int) (mHeaderMaxDragRate * mHeaderHeight));
        }
        if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
    ...
    protected boolean isEnableTranslationContent(boolean enable, RefreshInternal internal) {
        return enable || mEnablePureScrollMode || internal == null
...
//            reboundAnimator.setDuration(20000);
    ...
    protected void animSpinnerBounce(final float velocity) {
        if (reboundAnimator == null) {
            if (velocity > 0 && (mState == RefreshState.Refreshing
                || mState == RefreshState.TwoLevel)) {
                ...
                mEnableLoadMore) && mState != RefreshState.Refreshing))) {
    ...
    protected void moveSpinnerInfinitely(float spinner) {
        ...
        if (mState == RefreshState.TwoLevel && spinner > 0) {
            ...
            if (spinner < mHeaderHeight) {
                ...
                final double y = Math.min(M * (1 - Math.pow(100, -x / (H == 0 ? 1 : H))),
                    x);// 公式 y = M(1-100^(-x/H))
            ...
            final double y = Math
                .min(M * (1 - Math.pow(100, -x / (H == 0 ? 1 : H))), x);// 公式 y = M(1-100^(-x/H))
        ...
        if (mEnableAutoLoadMore && !mFooterNoMoreData && isEnableRefreshOrLoadMore(mEnableLoadMore)
            && spinner < 0
    ...
    public boolean onStartNestedScroll(@NonNull View child, @NonNull View target,
        ...
        final View thisView = this;
        boolean accepted = thisView.isEnabled() && isNestedScrollingEnabled()
            && (nestedScrollAxes & ViewCompat.SCROLL_AXIS_VERTICAL) != 0;
        accepted = accepted && (mEnableOverScrollDrag || isEnableRefreshOrLoadMore(mEnableRefresh)
            || isEnableRefreshOrLoadMore(mEnableLoadMore));
        return accepted;
    }
    ...
    public void onNestedScroll(@NonNull View target, int dxConsumed, int dyConsumed,
        ...
        if (dy != 0 && (mEnableOverScrollDrag || (dy < 0 && isEnableRefreshOrLoadMore(
            mEnableRefresh)) || (dy > 0 && isEnableRefreshOrLoadMore(mEnableLoadMore)))) {
            if (mViceState == RefreshState.None) {
                mKernel
                    .setState(dy > 0 ? RefreshState.PullUpToLoad : RefreshState.PullDownToRefresh);
            }
    ...
    public boolean onNestedPreFling(@NonNull View target, float velocityX, float velocityY) {
        return mFooterLocked && velocityY > 0 || startFlingIfNeed(-velocityY) || mNestedChild
...
//    }
    ...
    public SmartRefreshLayout setFooterHeight(float heightDp) {
        if (mFooterHeightStatus.canReplaceWith(DimensionStatus.CodeExact)) {
            mFooterHeight = SystemUtil.dp2px(heightDp);
    ...
    public SmartRefreshLayout setHeaderHeight(float heightDp) {
        if (mHeaderHeightStatus.canReplaceWith(DimensionStatus.CodeExact)) {
            mHeaderHeight = SystemUtil.dp2px(heightDp);
    ...
    public SmartRefreshLayout setHeaderInsetStart(float insetDp) {
        mHeaderInsetStart = SystemUtil.dp2px(insetDp);
        return this;
    }

    @Override
    public SmartRefreshLayout setFooterInsetStart(float insetDp) {
        mFooterInsetStart = SystemUtil.dp2px(insetDp);
        return this;
    }
    ...
    public SmartRefreshLayout setHeaderMaxDragRate(float rate) {
        ...
        if (mRefreshHeader != null && mHandler != null) {
            mRefreshHeader
                .onInitialized(mKernel, mHeaderHeight, (int) (mHeaderMaxDragRate * mHeaderHeight));
        } else {
    ...
    public SmartRefreshLayout setFooterMaxDragRate(float rate) {
        ...
        if (mRefreshFooter != null && mHandler != null) {
            mRefreshFooter
                .onInitialized(mKernel, mFooterHeight, (int) (mFooterHeight * mFooterMaxDragRate));
        } else {
     ...
     */
    @Override
    public SmartRefreshLayout setRefreshHeader(@NonNull RefreshHeader header, int width,
        int height) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public SmartRefreshLayout setRefreshFooter(@NonNull RefreshFooter footer, int width,
        int height) {
        if (mRefreshFooter != null) {
    ...
    public SmartRefreshLayout setNoMoreData(boolean noMoreData) {
        ...
        if (mRefreshFooter instanceof RefreshFooter && !((RefreshFooter) mRefreshFooter)
            .setNoMoreData(noMoreData)) {
            System.out.println(
                "Footer:" + mRefreshFooter + " NoMoreData is not supported.(不支持NoMoreData)");
        }
        return this;
    }
    ...
    public SmartRefreshLayout finishRefresh(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
        return finishRefresh(success ? Math.min(Math.max(0, 300 - (int) passTime), 300) : 0,
            success);//保证加载动画有300毫秒的时间
    }
            ...
            public void run() {
                if (mState == RefreshState.Refreshing && mRefreshHeader != null
                    ...
                    if (mOnMultiPurposeListener != null
                        ...
                        mOnMultiPurposeListener
                            .onHeaderFinish((RefreshHeader) mRefreshHeader, success);
                    }
                    if (startDelay < Integer.MAX_VALUE) {
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            SmartRefreshLayout.super.dispatchTouchEvent(
                                obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX,
                                    mLastTouchY + mSpinner, 0));
                        ...
                        if (mSpinner > 0) {
                            ...
                            ValueAnimator valueAnimator = animSpinner(0, startDelay,
                                mReboundInterpolator, mReboundDuration);
                            if (mEnableScrollContentWhenRefreshed) {
                                updateListener = mRefreshContent
                                    .scrollContentWhenFinished(mSpinner);
                            }
    ...
    public SmartRefreshLayout finishLoadMore(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
        return finishLoadMore(success ? Math.min(Math.max(0, 300 - (int) passTime), 300) : 0,
            success, false);
    }
        ...
        postDelayed(new Runnable() {
            ...
            public void run() {
                if (mState == RefreshState.Loading && mRefreshFooter != null
                    ...
                    final int startDelay = mRefreshFooter
                        .onFinish(SmartRefreshLayout.this, success);
                    if (mOnMultiPurposeListener != null
                        && mRefreshFooter instanceof RefreshFooter) {
                        mOnMultiPurposeListener
                            .onFooterFinish((RefreshFooter) mRefreshFooter, success);
                    }
                    if (startDelay < Integer.MAX_VALUE) {
                        //计算布局将要移动的偏移量
                        final boolean needHoldFooter =
                            noMoreData && mEnableFooterFollowWhenLoadFinished && mSpinner < 0
                                && mRefreshContent.canLoadMore();
                        final int offset =
                            mSpinner - (needHoldFooter ? Math.max(mSpinner, -mFooterHeight) : 0);
                        //如果正在拖动的话，偏移初始点击事件
                        if (mIsBeingDragged || mNestedInProgress) {
                            if (mIsBeingDragged) {
                                mTouchY = mLastTouchY;
    ...
    public boolean autoRefresh(int delayed) {
        return autoRefresh(delayed, mReboundDuration,
            1f * ((mHeaderMaxDragRate / 2 + 0.5f) * mHeaderHeight) / (mHeaderHeight == 0 ? 1
                : mHeaderHeight));
    }
            ...
            Runnable runnable = new Runnable() {
                ...
                public void run() {
                    reboundAnimator = ValueAnimator
                        .ofInt(mSpinner, (int) (mHeaderHeight * dragRate));
                    reboundAnimator.setDuration(duration);
    ...
    public boolean autoLoadMore(int delayed) {
        return autoLoadMore(delayed, mReboundDuration,
            1f * (mFooterHeight * (mFooterMaxDragRate / 2 + 0.5f)) / (mFooterHeight == 0 ? 1
                : mFooterHeight));
    }
    ...
    public boolean autoLoadMore(int delayed, final int duration, final float dragRate) {
        if (mState == RefreshState.None && (isEnableRefreshOrLoadMore(mEnableLoadMore)
            && !mFooterNoMoreData)) {
            if (reboundAnimator != null) {
                reboundAnimator.cancel();
            }
            Runnable runnable = new Runnable() {
                ...
                public void run() {
                    reboundAnimator = ValueAnimator
                        .ofInt(mSpinner, -(int) (mFooterHeight * dragRate));
                    reboundAnimator.setDuration(duration);
                    reboundAnimator.setInterpolator(new DecelerateInterpolator());
                    reboundAnimator.addUpdateListener(new AnimatorUpdateListener() {
                        @Override
    ...
    public boolean post(@NonNull Runnable action) {
        if (mHandler == null) {
            mListDelayedRunnable = mListDelayedRunnable == null ? new ArrayList<DelayedRunnable>()
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            ...
            TypedArray ta = context
                .obtainStyledAttributes(attrs, R.styleable.SmartRefreshLayout_Layout);
            backgroundColor = ta
                .getColor(R.styleable.SmartRefreshLayout_Layout_layout_srlBackgroundColor,
                    backgroundColor);
            if (ta.hasValue(R.styleable.SmartRefreshLayout_Layout_layout_srlSpinnerStyle)) {
                spinnerStyle = SpinnerStyle.values()[ta
                    .getInt(R.styleable.SmartRefreshLayout_Layout_layout_srlSpinnerStyle,
...
//    }
    ...
    protected class FlingRunnable implements Runnable {
        ...
        public Runnable start() {
            ...
            if (mSpinner != 0 && (
                !(mState.isOpening || (mFooterNoMoreData && mEnableFooterFollowWhenLoadFinished
                    && isEnableRefreshOrLoadMore(mEnableLoadMore)))
                    || ((mState == RefreshState.Loading || (mFooterNoMoreData
                    && mEnableFooterFollowWhenLoadFinished && isEnableRefreshOrLoadMore(
                    mEnableLoadMore))) && mSpinner < -mFooterHeight)
...
//                mVelocity *= Math.pow(mDamping, ++mFrame);
                ...
                if (Math.abs(velocity) >= 1) {
                    ...
                    if (Math.abs(mSpinner) >= Math.abs(mSmoothDistance)) {
                        int duration = 10 * Math.min(
                            Math.max((int) SystemUtil.px2dp(Math.abs(mSpinner - mSmoothDistance)),
                                30), 100);
    ...
    public class RefreshKernelImpl implements RefreshKernel {
        ...
        public RefreshKernel setState(@NonNull RefreshState state) {
            switch (state) {
                ...
                case PullDownToRefresh:
                    ...
                    break;
                case PullUpToLoad:
                    if (isEnableRefreshOrLoadMore(mEnableLoadMore) && !mState.isOpening
                        && !mState.isFinishing && !(mFooterNoMoreData
                        && mEnableFooterFollowWhenLoadFinished)) {
                ...
                case PullUpCanceled:
                    if (isEnableRefreshOrLoadMore(mEnableLoadMore) && !mState.isOpening && !(
                        mFooterNoMoreData && mEnableFooterFollowWhenLoadFinished)) {
        ...
        public RefreshKernel moveSpinner(int spinner, boolean isDragging) {
            ...
            if (mRefreshContent != null) {
                ...
                if (spinner >= 0 && mRefreshHeader != null) {
                    if (isEnableTranslationContent(mEnableHeaderTranslationContent,
                        mRefreshHeader)) {
                        tSpinner = spinner;
                ...
                if (spinner <= 0 && mRefreshFooter != null) {
                    if (isEnableTranslationContent(mEnableFooterTranslationContent,
                        mRefreshFooter)) {
                        tSpinner = spinner;
                    } else if (oldSpinner > 0) {
                        tSpinner = 0;
                ...
                if (tSpinner != null) {
                    mRefreshContent
                        .moveSpinner(tSpinner, mHeaderTranslationViewId, mFooterTranslationViewId);
                    boolean header = mEnableClipHeaderWhenFixedBehind && mRefreshHeader != null
                        && mRefreshHeader.getSpinnerStyle() == SpinnerStyle.FixedBehind;
                    header = header || mHeaderBackgroundColor != 0;
                    boolean footer = mEnableClipFooterWhenFixedBehind && mRefreshFooter != null
                        && mRefreshFooter.getSpinnerStyle() == SpinnerStyle.FixedBehind;
            ...
            if ((spinner >= 0 || oldSpinner > 0) && mRefreshHeader != null) {
                ...
                if (isEnableRefreshOrLoadMore(mEnableRefresh) || (
                    ...
                    if (oldSpinner != mSpinner) {
                        if (mRefreshHeader.getSpinnerStyle() == SpinnerStyle.Translate) {
                            ...
                            if (mHeaderBackgroundColor != 0 && mPaint != null
                                && !isEnableTranslationContent(mEnableHeaderTranslationContent,
                                mRefreshHeader)) {
                                thisView.invalidate();
                            }
                        ...
                        mRefreshHeader
                            .onMoving(isDragging, percent, offset, headerHeight, maxDragHeight);
                    }
                ...
                if (oldSpinner != mSpinner && mOnMultiPurposeListener != null
                    && mRefreshHeader instanceof RefreshHeader) {
                    mOnMultiPurposeListener
                        .onHeaderMoving((RefreshHeader) mRefreshHeader, isDragging, percent, offset,
            ...
            if ((spinner <= 0 || oldSpinner < 0) && mRefreshFooter != null) {
                ...
                if (isEnableRefreshOrLoadMore(mEnableLoadMore) || (mState == RefreshState.LoadFinish
                    && !isDragging)) {
                    if (oldSpinner != mSpinner) {
                        if (mRefreshFooter.getSpinnerStyle() == SpinnerStyle.Translate) {
                            mRefreshFooter.getView().setTranslationY(mSpinner);
                            if (mFooterBackgroundColor != 0 && mPaint != null
                                && !isEnableTranslationContent(mEnableFooterTranslationContent,
                                mRefreshFooter)) {
                                thisView.invalidate();
                            }
                        ...
                        mRefreshFooter
                            .onMoving(isDragging, percent, offset, footerHeight, maxDragHeight);
                    }
                ...
                if (oldSpinner != mSpinner && mOnMultiPurposeListener != null
                    && mRefreshFooter instanceof RefreshFooter) {
                    mOnMultiPurposeListener
                        .onFooterMoving((RefreshFooter) mRefreshFooter, isDragging, percent, offset,
        ...
        @Override
        public RefreshKernel requestDrawBackgroundFor(@NonNull RefreshInternal internal,
            int backgroundColor) {
        ...
        @Override
        public RefreshKernel requestNeedTouchEventFor(@NonNull RefreshInternal internal,
            boolean request) {
            if (internal.equals(mRefreshHeader)) {
