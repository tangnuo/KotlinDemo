...
import com.kedacom.widget.refreshlayout.header.storehouse.StoreHouseBarItem;
import com.kedacom.widget.refreshlayout.header.storehouse.StoreHousePath;
import com.kedacom.widget.refreshlayout.internal.InternalAbstract;
import java.util.ArrayList;
import java.util.List;

/**
 * StoreHouseHeader from https://github.com/liaohuqiu/android-Ultra-Pull-To-Refresh
 */
...
public class StoreHouseHeader extends InternalAbstract implements RefreshHeader {
    ...
    public StoreHouseHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mLineWidth = ta
            .getDimensionPixelOffset(R.styleable.StoreHouseHeader_shhLineWidth, mLineWidth);
        mDropHeight = ta
            .getDimensionPixelOffset(R.styleable.StoreHouseHeader_shhDropHeight, mDropHeight);
        mEnableFadeAnimation = ta
            .getBoolean(R.styleable.StoreHouseHeader_shhEnableFadeAnimation, mEnableFadeAnimation);
        ...
        thisView.setMinimumHeight(mDrawZoneHeight + dp2px(40));
    }
            ...
            if (mIsInLoading) {
                ...
                if (progress == 1 || progress >= 1 - endPadding) {
                    ...
                    if (progress <= startPadding) {
                        ...
                        realProgress = Math
                            .min(1, (progress - startPadding) / mInternalAnimationFactor);
                    }
