...
import com.kedacom.util.SystemUtil.dp2px
...
class LabelView : View {
    ...
    private fun obtainAttributes(context: Context, attrs: AttributeSet?) {
        ...
        mTextSize = ta.getDimension(R.styleable.LabelView_lv_text_size, SystemUtil.sp2px(11f).toFloat())
        ...
        mMinSize = ta.getDimension(R.styleable.LabelView_lv_min_size, (if (mFillTriangle) dp2px(35f) else dp2px(50f)).toFloat())
    ...
    fun setTextSize(textSize: Float) {
        mTextSize = SystemUtil.sp2px(textSize).toFloat()
        invalidate()
    }
    ...
    private fun drawText(size: Int, degrees: Float, canvas: Canvas, textHeight: Float, isTop: Boolean) {
        ...
        canvas.drawText(if (mTextAllCaps) mTextContent.toUpperCase() else mTextContent,
