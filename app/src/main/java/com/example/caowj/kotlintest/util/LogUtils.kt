...
object LogUtils {
    ...
    private val LogTag = "caowj"

    init {
        Log.e(LogTag, TOP_LINE)
        initLogFile()
    }


    fun v(tag: String = LogTag, msg: String) = debug.debugLog(tag, msg, Log.VERBOSE)
    fun d(tag: String = LogTag, msg: String) = debug.debugLog(tag, msg, Log.DEBUG)
    fun i(tag: String = LogTag, msg: String) = debug.debugLog(tag, msg, Log.INFO)
    fun w(tag: String = LogTag, msg: String) = debug.debugLog(tag, msg, Log.WARN)
    fun e(tag: String = LogTag, msg: String) = debug.debugLog(tag, msg, Log.ERROR)
